<template>
    ...
    <q-page padding class="flex flex-center">
      ...
      <div class="q-gutter-md" style="max-width: 350px">
        <p  class="text-h5 text-weight-light text-center" style="color:#2196F3">Unos novog korisnika</p>
        ...
        <q-input ref="adresaRef" v-model="inputAdresa" label="Adresa" placeholder="Adresa ">
        </q-input>

        <q-input ref="brojRef" v-model="inputBroj" label="Broj" placeholder="Broj ">
        </q-input>
  ...
  <q-dialog v-model="showDialog">
        <q-card>
          <q-card-section> Korisnik je uspješno dodan! </q-card-section>
